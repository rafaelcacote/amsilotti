        ...
        <div class="animated fadeIn">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <form id="tarefaForm" action="{{ route('controle_de_tarefas.store') }}" method="POST">
                                @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="processo" name="processo" value="{{ old('processo') }}">
                                                @error('processo')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('descricao_atividade') is-invalid @enderror" id="descricao_atividade"
                                                    name="descricao_atividade" rows="3">{{ old('descricao_atividade') }}</textarea>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('prioridade') is-invalid @enderror"
                                                    ...
                                                    <option value="">Selecione</option>
                                                    <option value="baixa"
                                                        {{ old('prioridade') == 'baixa' ? 'selected' : '' }}>Baixa</option>
                                                    <option value="media"
                                                        {{ old('prioridade') == 'media' ? 'selected' : '' }}>Média</option>
                                                    <option value="alta"
                                                        {{ old('prioridade') == 'alta' ? 'selected' : '' }}>Alta</option>
                                                </select>
                                                @error('prioridade')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('membro_id') is-invalid @enderror"
                                                    id="membro_id" name="membro_id">
                                                    <option value="">Selecione</option>
                                                    @foreach ($membros as $membro)
                                                        <option value="{{ $membro->id }}"
                                                            {{ old('membro_id') == $membro->id ? 'selected' : '' }}>
                                                            {{ $membro->nome }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('prazo') is-invalid @enderror"
                                                    ...
                                                    <option value="">Selecione</option>
                                                    <option value="1 dia"
                                                        {{ old('prazo') == '1 dia' ? 'selected' : '' }}>
                                                        1 dia</option>
                                                    <option value="2 dias"
                                                        {{ old('prazo') == '2 dias' ? 'selected' : '' }}>2 dias</option>
                                                    <option value="3 dias"
                                                        {{ old('prazo') == '3 dias' ? 'selected' : '' }}>3 dias</option>
                                                    <option value="4 dias"
                                                        {{ old('prazo') == '4 dias' ? 'selected' : '' }}>4 dias</option>
                                                    <option value="5 dias"
                                                        {{ old('prazo') == '5 dias' ? 'selected' : '' }}>5 dias</option>
                                                    <option value="1 semana"
                                                        {{ old('prazo') == '1 semana' ? 'selected' : '' }}>1 semana
                                                    </option>
                                                    <option value="2 semanas"
                                                        {{ old('prazo') == '2 semanas' ? 'selected' : '' }}>2 semanas
                                                    </option>
                                                    <option value="3 semanas"
                                                        {{ old('prazo') == '3 semanas' ? 'selected' : '' }}>3 semanas
                                                    </option>
                                                    <option value="1 mês"
                                                        {{ old('prazo') == '1 mês' ? 'selected' : '' }}>1 mês</option>
                                                </select>
                                                @error('prazo')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                ...
                                <!-- Seção: Situação -->
                                <div class="mb-4">
                                    <h5 class="text-primary mb-3"><i class="fas fa-check-circle me-2"></i>Situação e Status</h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
