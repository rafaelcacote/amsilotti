                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-muted mb-2"><i class="fas fa-file-alt me-2"></i>Descrição da Atividade</h6>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="badge fs-6 bg-@statusColor($controleDeTarefas->status) py-2 px-3">
                                            {{ $controleDeTarefas->status }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-muted mb-2"><i class="fas fa-exclamation-circle me-2"></i>Prioridade</h6>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-muted mb-2"><i class="far fa-calendar-alt me-2"></i>Data de Início</h6>
                                        <p class="fs-5 mb-0">{{ $controleDeTarefas->data_inicio->format('d/m/Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-muted mb-2"><i class="far fa-calendar-check me-2"></i>Data de Término</h6>
                                        <p class="fs-5 mb-0">
                                            {{ $controleDeTarefas->data_termino ? $controleDeTarefas->data_termino->format('d/m/Y') : 'N/A' }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="d-flex flex-column">
                                        ...
                                        <p class="fs-5 mb-0">{{ $controleDeTarefas->situacao }}</p>
                                    </div>
                                </div>
                            </div>
