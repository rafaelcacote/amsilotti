                        ...
                        <div class="card-body">
                            <form action="{{ route('users.store') }}" method="POST" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('cpf') is-invalid @enderror" id="cpf" name="cpf" value="{{ old('cpf') }}" maxlength="11" pattern="[0-9]*" inputmode="numeric" placeholder="Somente números (11 dígitos)">
                                    @error('cpf')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
