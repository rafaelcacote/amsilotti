                            ...
                            <form action="{{ route('users.update', $user->id) }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('cpf') is-invalid @enderror"
                                        id="cpf" name="cpf" value="{{ old('cpf', $user->cpf) }}" maxlength="11"
                                ...
                                <div class="col-md-12">
                                    <label class="form-label" for="password">Nova Senha <strong>(deixe em branco para manter
                                            atualizado)</strong></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        <option value="A" {{ old('status', $user->status) == 'A' ? 'selected' : '' }}>
                                            Ativo</option>
                                        <option value="I" {{ old('status', $user->status) == 'I' ? 'selected' : '' }}>
                                            Inativo</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
