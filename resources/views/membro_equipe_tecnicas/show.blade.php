            ...
            <div class="col-sm-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom d-flex align-items-center py-3">
                        <h3 class="mb-0 text-primary"><i class="fas fa-users me-2"></i>Detalhes do Membro da Equipe Técnica</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <span class="badge {{ $membroEquipeTecnica->cargo == 'Perita Judicial' ? 'bg-primary' : 'bg-info' }} fs-6">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <a href="{{ route('membro-equipe-tecnicas.index') }}" class="btn btn-outline-secondary me-2">
                                <i class="fas fa-arrow-left me-1"></i> Voltar
                            </a>
                            <a href="{{ route('membro-equipe-tecnicas.edit', $membroEquipeTecnica->id) }}" class="btn btn-primary me-2">
