                        ...
                        <div class="card-body">
                            <form action="{{ route('bairros.update', $bairro->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nome') is-invalid @enderror" id="nome" name="nome" value="{{ old('nome', $bairro->nome) }}" required>
                                    @error('nome')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('zona_id') is-invalid @enderror" id="zona_id" name="zona_id" required>
                                        ...
                                        @foreach ($zonas as $zona)
                                            <option value="{{ $zona->id }}" {{ old('zona_id', $bairro->zona_id) == $zona->id ? 'selected' : '' }}>
                                                {{ $zona->nome }}
                                            </option>
                                        @endforeach
                                    </select>
