                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('zona_id') is-invalid @enderror" id="zona" name="zona_id">
                                                    ...
                                                    @foreach ($zonas as $item)
                                                        <option value="{{ $item->id }}" {{ old('zona_id') == $item->id ? 'selected' : '' }}>
                                                            {{ $item->nome }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('pgm') is-invalid @enderror" id="pgm" name="pgm" value="{{ old('pgm') }}">
                                                @error('pgm')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('topologia') is-invalid @enderror" id="topologia" name="topologia">
                                                    ...
                                                    <option value="superficie_seca" {{ old('topologia') == 'superficie_seca' ? 'selected' : '' }}>Superfície Seca</option>
                                                    <option value="superficie_alagada" {{ old('topologia') == 'superficie_alagada' ? 'selected' : '' }}>Superfície Permanentemente Alagada</option>
                                                    <option value="superficie_brejosa" {{ old('topologia') == 'superficie_brejosa' ? 'selected' : '' }}>Superfície Brejosa</option>
                                                </select>
                                                @error('topologia')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('topografia') is-invalid @enderror" id="topografia" name="topografia">
                                                    ...
                                                    <option value="caido_fundo_5" {{ old('topografia') == 'caido_fundo_5' ? 'selected' : '' }}>Caído para Fundo de 5%</option>
                                                    <option value="caido_fundo_10" {{ old('topografia') == 'caido_fundo_10' ? 'selected' : '' }}>Caído para Fundo de 10%</option>
                                                    <option value="aclive_10" {{ old('topografia') == 'aclive_10' ? 'selected' : '' }}>Em Aclive 10%</option>
                                                    <option value="aclive_20" {{ old('topografia') == 'aclive_20' ? 'selected' : '' }}>Em Aclive 20%</option>
                                                    <option value="abaixo_nivel_1m" {{ old('topografia') == 'abaixo_nivel_1m' ? 'selected' : '' }}>Abaixo do Nível da Rua 1M</option>
                                                    <option value="abaixo_nivel_1_2_5m" {{ old('topografia') == 'abaixo_nivel_1_2_5m' ? 'selected' : '' }}>Abaixo do Nível da Rua 1 à 2.50M</option>
                                                    <option value="acima_nivel_2m" {{ old('topografia') == 'acima_nivel_2m' ? 'selected' : '' }}>Acima do Nível da Rua até 2M</option>
                                                    <option value="acima_nivel_2_4m" {{ old('topografia') == 'acima_nivel_2_4m' ? 'selected' : '' }}>Acima do Nível da Rua 2M até 4M</option>
                                                </select>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('padrao') is-invalid @enderror" id="padrao" name="padrao">
                                                    ...
                                                    <option value="simples" {{ old('padrao') == 'simples' ? 'selected' : '' }}>Simples</option>
                                                    <option value="medio" {{ old('padrao') == 'medio' ? 'selected' : '' }}>Médio</option>
                                                    <option value="fino" {{ old('padrao') == 'fino' ? 'selected' : '' }}>Fino</option>
                                                </select>
                                                @error('padrao')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="mb-3">
                                                <label for="estado_conservacao" class="form-label">Estado de
                                                    ...
                                                    <select class="form-select @error('estado_conservacao') is-invalid @enderror" id="estado_conservacao" name="estado_conservacao">
                                                        ...
                                                        <option value="bom" {{ old('estado_conservacao') == 'bom' ? 'selected' : '' }}>Bom – 0,00</option>
                                                        <option value="muito_bom" {{ old('estado_conservacao') == 'muito_bom' ? 'selected' : '' }}>Muito Bom – 0,32</option>
                                                        <option value="otimo" {{ old('estado_conservacao') == 'otimo' ? 'selected' : '' }}>Ótimo – 2,52</option>
                                                        <option value="intermediario" {{ old('estado_conservacao') == 'intermediario' ? 'selected' : '' }}>Intermediário – 8,09</option>
                                                        <option value="regular" {{ old('estado_conservacao') == 'regular' ? 'selected' : '' }}>Regular – 18,10</option>
                                                        <option value="deficiente" {{ old('estado_conservacao') == 'deficiente' ? 'selected' : '' }}>Deficiente – 33,20</option>
                                                        <option value="mau" {{ old('estado_conservacao') == 'mau' ? 'selected' : '' }}>Mau – 52,60</option>
                                                        <option value="muito_mau" {{ old('estado_conservacao') == 'muito_mau' ? 'selected' : '' }}>Muito Mau – 75,20</option>
                                                        <option value="demolicao" {{ old('estado_conservacao') == 'demolicao' ? 'selected' : '' }}>Demolição – 100,00</option>
                                                    </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('acessibilidade') is-invalid @enderror" id="acessibilidade" name="acessibilidade">
                                                    ...
                                                    <option value="conducao_direta" {{ old('acessibilidade') == 'conducao_direta' ? 'selected' : '' }}>Condução Direta</option>
                                                    <option value="conducao_menos_1000m" {{ old('acessibilidade') == 'conducao_menos_1000m' ? 'selected' : '' }}>Condução a Menos de 1.000M</option>
                                                </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        id="idade_predio" name="idade_predio" value="{{ old('idade_predio') }}">
                                                    @error('idade_predio')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        id="quatidade_suites" name="quatidade_suites" value="{{ old('quatidade_suites') }}">
...
{{-- controle de campos dependendo do tipo do imovel  --}}
    <script>
      function toggleSections() {
            const tipo = document.getElementById('tipo').value || "{{ old('tipo') }}";
...
{{-- rege fotos par inserir com miniatura e descrição --}}
<script>
